...
(function () {
  const DESKTOP_APPS = [
    ...
    // Motocross Madness trial: the game reads its bike models, terrain
    // heightfields, UI bitmaps and audio straight off the CD path, so the page
    // has to mount the whole tree or the D3D loop flips empty frames forever
    // (598 BeginScene/EndScene pairs, zero DrawPrimitive) and the profile
    // dialog cannot find ui\profile\*.*. Grouped by directory to stay
    // readable; expanded to the same flat path list the CLI mounts.
    const mcmFiles = [
    ...
    ].flatMap(([dir, names]) => names.split(' ').map(n => `binaries/shareware/mcm/mcm_ex/${dir}${n}`));
    ...
    const APPS = {
      ...
      quake2_demo: {
        ...
        dlls: [quake2GameDll, quake2RefSoft],
        files: quake2DemoFiles,
        requiredFiles: true,
        // Fresh profiles enter the attract demo on their own, but Quake also
        // reloads a persisted config.cfg. Start the shipped demo map
        // explicitly so a stale attract/menu state cannot leave the browser
        // presenting a valid but all-black DirectDraw frame.
      ...
      aoe2:       { exe: 'binaries/shareware/aoe2/aoe2_ex/EMPIRES2.EXE', fileConcurrency: 4, files: [
        'binaries/shareware/aoe2/aoe2_ex/language.dll',
        // The .drs archives hold every sprite, tile and interface bitmap. With
        // them absent the game opens them OPEN_ALWAYS, gets empty files, fails
        // to load interface resource 50500 and reports it as "Could not
        // initialize graphics system ... compatible with DirectDraw".
        'binaries/shareware/aoe2/aoe2_ex/Data/interfac.drs',
        'binaries/shareware/aoe2/aoe2_ex/Data/gamedata.drs',
        'binaries/shareware/aoe2/aoe2_ex/Data/terrain.drs',
        'binaries/shareware/aoe2/aoe2_ex/Data/graphics.drs',
        'binaries/shareware/aoe2/aoe2_ex/Data/sounds.drs',
        'binaries/shareware/aoe2/aoe2_ex/Data/empires2.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/blendomatic.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/BlkEdge.Dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/TileEdge.Dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/PatternMasks.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/FilterMaps.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/LoQMaps.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/STemplet.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/lightMaps.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/view_icm.dat',
        'binaries/shareware/aoe2/aoe2_ex/Data/shadow.col',
      ...
      mw3:        { exe: 'binaries/shareware/mw3/ex/Program_Files/mech3demo.exe', files: [
        ...
        ...mw3DatabaseFiles,
      ], requiredFiles: true, fileConcurrency: 10 },
