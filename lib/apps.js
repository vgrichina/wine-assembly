  ...
  const DESKTOP_APPS = [
    ...
    const APPS = {
      ...
      ski32: {
        ...
        // SkiFree steers with the arrow keys and sprints on F; F2 starts a new
        // run. None of that is reachable on a phone without these — see
        // lib/touch-controls.js.
        touchControls: {
          dpad: { pos: 'bl' },
          buttons: [
            { vk: 0x46, label: 'F', title: 'Fast', pos: 'br' },
            { vk: 0x71, label: 'F2', title: 'New game', pos: 'br', row: 1 },
          ],
        },
      },
      liquid_war: {
      ...
      pinball: {
        ...
        // flippers, Space is the plunger, X nudges, F2 starts a new game. The
        // two flippers must be held together, which is why the overlay tracks
        // touches by identifier.
        touchControls: {
          buttons: [
            { vk: 0x5A, label: 'Z', title: 'Left flipper', pos: 'bl', width: 96 },
            { vk: 0x58, label: 'X', title: 'Nudge', pos: 'bl', row: 1 },
            { vk: 0xBF, label: '/', title: 'Right flipper', pos: 'br', width: 96 },
            { vk: 0x20, label: 'Plunger', pos: 'br', row: 1 },
            // Top-LEFT: the page-fullscreen exit button and the debug peek
            // both live in the top-right corner.
            { vk: 0x71, label: 'F2', title: 'New game', pos: 'tl' },
          ],
        },
      },
