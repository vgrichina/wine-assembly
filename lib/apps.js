    ...
    const APPS = {
      ...
      winamp:     {
        ...
        files: [
          ...
          // pane opens. vis_avs is deliberately absent: it loads and exports
          // winampVisGetHeader, but the enumerator never returns from calling
          // it, and that takes the whole pane down with it.
