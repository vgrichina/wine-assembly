  ...
  const DESKTOP_APPS = [
    ...
    const APPS = {
      ...
      jazz2_demo: {
        ...
        requiredFiles: true,
        fileConcurrency: 10,
        // Skip the long shareware logo video and load the playable shareware
        // episode deterministically. Network discovery is irrelevant for the
        // local single-player dropdown and delays startup substantially.
