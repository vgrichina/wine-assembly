...
(function () {
  const DESKTOP_APPS = [
    ...
    const brokenSwordRoot = win98GamesADRoot + 'Broken_Sword_demo-SW/';
    const dungeonKeeperRoot = win98GamesADRoot +
      'Dungeon Keeper Demo-SWonly/Rozbaleny/';
    const darkstoneRoot = win98GamesADRoot + 'DarkstoneDemo-D3D/data/';
    ...
    const APPS = {
      ...
      broken_sword_demo: {
        ...
        requiredFiles: true,
        fileConcurrency: 12,
        // Its opening Smacker sequence never presents a visible frame in the
        // browser, although the game remains live. Escape skips only that
        // optional intro and reveals the normally rendered café scene.
        startupInput: { vk: 0x1B, delayMs: 1500, holdMs: 30 },
      },
      dungeon_keeper_demo: {
      ...
      bakkslide7: {
        ...
        dismissStartupDialog: { command: 1002 },
