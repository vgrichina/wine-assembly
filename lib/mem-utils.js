...
const VIRTUAL_MAP_STATE = _regionMap.BASE.VIRTUAL_MAP_STATE;
const VIRTUAL_MAP_TABLE = _regionMap.BASE.VIRTUAL_MAP_TABLE;
...
function g2w(guestAddr, imageBase, memory) {
  ...
  const buffer = memoryBufferOf(memory);
  if (buffer) {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    memoryBufferOf, readStrA, readStrW, g2w, g2wSpan, walkStackFrame, formatFrames,
