...
function installInputHandlers(R) {
  ...
  // Limit that capture to an exclusive presentation whose guest has actively
  // called ClipCursor around the point: ordinary desktop windows and controls
  // keep normal absolute pointer semantics.
