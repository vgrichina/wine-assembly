...
(function (root, factory) {
  ...
  class FixedFunctionGL {
    ...
    _applyUniforms() {
      ...
      const values = {
        uModelView: ['matrix4', this.matrices[C.MODELVIEW].slice(-1)[0]],
        uProjection: ['matrix4', this.matrices[C.PROJECTION].slice(-1)[0]],
        uTextureMatrix: ['matrix4', this.matrices[C.TEXTURE].slice(-1)[0]],
