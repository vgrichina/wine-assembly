...
(function (root, factory) {
  ...
  const GPU_CALLS = ['gpuPresent', 'glColor4ub'];
  ...
  class FixedFunctionGL {
    ...
    _applyUniforms() {
      ...
      let projection = this.matrices[C.PROJECTION].slice(-1)[0];
  ...
  class OpenGLHostBridge {
    ...
    _call(opcode, stack, aux) {
      ...
      switch (name) {
        ...
        case 'glColor4ub':
          f.color = [0, 1, 2, 3].map(i => this._u32(stack, i) & 0xFF).map(value => value / 255);
          break;
