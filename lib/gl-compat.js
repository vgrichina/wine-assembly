...
(function (root, factory) {
  ...
  const api = factory(backendApi, commandApi);
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  if (root) root.OpenGLCompat = api;
})(typeof globalThis !== 'undefined' ? globalThis : this, function (GpuBackend, GLCommandStream) {
  'use strict';
  ...
  class OpenGLHostBridge {
    ...
    _stackDv() { return this._capture ? new DataView(this._capture.buffer) : this._dv(); }
