...
const _surfaceLib = (typeof require !== 'undefined')
  ? require('./surface')
  : (typeof window !== 'undefined' ? window.surfaceLib : null);

function makeSurface(canvas) {
  return _surfaceLib ? _surfaceLib.surfaceFromCanvas(canvas) : null;
}
...
class Win98Renderer {
  ...
  _drawImageClipped(canvas, x, y, w, h, clipRect) {
    ...
    const blit = () => this._blitSurface(canvas, x, y, dw, dh);
