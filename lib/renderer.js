...
class Win98Renderer {
  ...
  _computeClientRect(win) {
    ...
    const hasCaption = (win.style & 0x00C00000) === 0x00C00000;
  ...
  getWindowCanvas(hwnd) {
    ...
    if (!win._backCanvas || win._backW !== w || win._backH !== h) {
      ...
      win._backW = w;
      win._backH = h;
      const borderlessTopLevel = !win.isChild && ((win.style & 0x00C00000) !== 0x00C00000) && !this._hasMenuBar(win);
  ...
  _repaintOnce() {
    ...
    for (const win of sorted) {
      ...
      const e = (win.wasm || this.wasm) && (win.wasm || this.wasm).exports;
      if (!win.isChild && ((win.style & 0x00C00000) === 0x00C00000) && e && e.nc_repaint_now) {
  ...
  drawWindow(win) {
    ...
    win.hasCaption = (win.style & 0x00C00000) === 0x00C00000;
