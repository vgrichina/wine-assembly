  ...
  function createBrowserShell(deps) {
    ...
    function autoRunSliceFor(appKey, compatDispatch, workerMode) {
      switch (appKey) {
        ...
        // Its menu also blends large owner-drawn bitmaps in the guest. Keep
        // that work interruptible while it shares the browser main thread;
        // a confirmed guest Worker can retain the lower-overhead 1k slice.
        case 'halflife_uplink':
          return workerMode ? 1000 : 250;
