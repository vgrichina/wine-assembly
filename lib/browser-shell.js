  ...
  function createBrowserShell(deps) {
    ...
    function autoRunSliceFor(appKey, compatDispatch, workerMode) {
      switch (appKey) {
        ...
        // Its menu blends and blits every animated button before creating the
        // difficulty dialog. A 250-block slice underfeeds that transition on
        // Safari; 1k still yields regularly and reaches Easy.
