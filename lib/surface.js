...
// UMD, so the same file serves Node and the browser page. The browser must
// load this before renderer.js -- the renderer asks for a surface in its
// constructor, and without this it gets null and repaint() throws on the
// first frame.
(function (root, factory) {
  const api = factory();
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  if (root) root.surfaceLib = api;
