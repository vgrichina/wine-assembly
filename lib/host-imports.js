  ...
  const host = {
    ...
    next_dirty_hwnd: () => {
      ...
      for (const hwnd of _updateRgns.keys()) {
        ...
        // Phase A.2 prerequisite: skip BS_OWNERDRAW children. They get
        // repainted by the parent's WM_PAINT walk via WM_DRAWITEM (legacy
        // path). Direct WM_PAINT to an OWNERDRAW button posts WM_DRAWITEM
        // to a parent (e.g. mspaint Tools/CToolBar) whose wndproc doesn't
        // paint, and the icons disappear.
