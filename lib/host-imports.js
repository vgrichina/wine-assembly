...
function createHostImports(ctx) {
  ...
  const _getDC = (hdc) => {
    if (!_dcState[hdc]) _dcState[hdc] = { penColor: 0x000000, penWidth: 1, brushColor: 0xFFFFFF, selectedBrush: 0x30010, textColor: 0x000000, bkColor: 0xFFFFFF, bkMode: 2, posX: 0, posY: 0, selectedFont: 0 };
    return _dcState[hdc];
  };
