...
function createHostImports(ctx) {
  ...
  return { host, readStr, gdi: { _gdiObjects, _dcState, _gdiAlloc, _getDC, _getClientOrigin, handleBox: _handleBox, _dcTable, dcHandleBox: _dcHandleBox, presentBestDxOffscreen: _presentBestDxOffscreen } };
}
