...
function createHostImports(ctx) {
  ...
  if (trace.has('gdi')) {
    ...
    for (const name of [
      'gdi_set_region_bands', 'gdi_set_window_rgn', 'gdi_present_dib_rect',
      'gdi_set_text_color', 'gdi_get_bk_color', 'gdi_get_text_color',
      'gdi_get_bk_mode', 'gdi_set_bk_color', 'gdi_set_bk_mode',
      'gdi_set_text_align', 'gdi_get_text_align', 'gdi_text_out',
      'gdi_ext_text_out', 'gdi_draw_text',
    ]) wrap(name, host[name]);
  }
