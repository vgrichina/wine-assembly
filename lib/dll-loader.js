...
function loadDlls(exports, memory, exeBytes, dlls, log, options = {}) {
  ...
  for (const dll of dlls) {
    ...
    if (log && exports.get_heap_ptr) log(`[DBG] heap_ptr after loading ${dll.name}: 0x${exports.get_heap_ptr().toString(16)}`);
  ...
  if (log && exports.get_heap_ptr) log(`[DBG] heap_ptr before DllMain: 0x${exports.get_heap_ptr().toString(16)}`);
  ...
  if (log && exports.get_heap_ptr) log(`[DBG] heap_ptr after DllMain: 0x${exports.get_heap_ptr().toString(16)}`);
