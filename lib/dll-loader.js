...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { loadDll, loadDlls, patchExeImports, patchDllImports, callDllMain, detectRequiredDlls, shouldReportNtForDlls, DLL_CONFIGS };
} else if (typeof window !== 'undefined') {
  window.DllLoader = { loadDll, loadDlls, patchExeImports, patchDllImports, callDllMain, detectRequiredDlls, shouldReportNtForDlls, DLL_CONFIGS };
}
