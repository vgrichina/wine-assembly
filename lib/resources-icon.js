// Browser-side icon extractor for the desktop. Finds the first RT_GROUP_ICON,
// picks its best entry (32x32, highest bpp), pulls the matching RT_ICON DIB,
// decodes it via parseDIB from lib/dib.js, then encodes to a data URL. Pure
// host code — does not touch WASM, so it runs before any guest is loaded.
//
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { extractIconRgba, peResourceReader, neResourceReader };
