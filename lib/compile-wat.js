...
// MIRROR, NOT MASTER. src/main.watx is the authoritative source order
// (Milestone 2.1 of docs/watx-migration-plan.md); this array reproduces its
// include list so the legacy compiler stays a plain JS module with no parse
// step at require time. tools/check-wat-manifest.js — the first gate in
// tools/build.sh — fails when the two disagree, as a sequence. Edit
// src/main.watx first, then mirror the change here.
//
...
const WAT_FILES = [
  ...
  '05c-seg16-ops.wat',
  '06-fpu.wat', '06b-core-handlers.wat', '06c-mmx.wat', '07-decoder.wat', '07b-loop-match.wat',
  '08-pe-loader.wat', '08b-dll-loader.wat',
  '08c-ne-loader.wat',
  ...
  '09a7-handlers-dispatch.wat', '09a7b-ole.wat', '09a7c-mixer.wat',
  '09a8-handlers-directx.wat',
  '09a8b-handlers-opengl.wat',
  '09a9-comctl32.wat',
  '09aa-handlers-d3dim.wat', '09ab-handlers-d3dim-core.wat', '09ad-handlers-d3d9.wat',
  '09b-dispatch.wat', '09b2-dispatch-table.generated.wat',
  '09c-help.wat', '09c0-window-table.wat', '09c2-treeview.wat', '09c3-controls.wat', '09c4-defwndproc.wat', '09c5-menu.wat',
  '09c6-winhelp-core.wat', '09c7-winhelp-hlp.wat', '09c8-winhelp-cnt.wat', '09c9-winhelp-ui.wat', '09d-winsock.wat',
  '09d2-tapi.wat',
  '09e-win16-api.wat', '09e2-win16-dialog.wat', '09f-win16-ddeml.wat',
  '10-helpers.wat', '10a-gdi-bitmap.wat', '10b-gdi-font.wat', '10c-truetype.wat',
  '10c1-truetype-hint.wat',
  '10d-gdi-region-path.wat', '10e-gdi-metafile.wat', '10f-gdi-dc.wat',
  '10g-gdi-raster.wat',
  '11-seh.wat', '12-wsprintf.wat', '13-exports.wat',
];
...
async function compileWatSnapshot(readFile, options = {}) {
  ...
  await Promise.all((options.files || WAT_FILES).map(async file => {
...
async function compileWat(readFile, options = {}) {
  ...
  const compilePromise = (async () => {
    try {
      ...
      const sourceFiles = options.files || WAT_FILES;
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { compileWat, compileWatSnapshot, WAT_FILES };
}
