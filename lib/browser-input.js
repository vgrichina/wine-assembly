...
(function () {
  ...
  function wireCanvasInput(canvas, renderer, deps) {
    ...
    function requestGuestPointerLock(canvasX, canvasY) {
      if (!canvas.requestPointerLock || pointerLocked() ||
          !renderer.wantsRelativeMouse || !renderer.wantsRelativeMouse(canvasX, canvasY)) return;
      ...
      // through GetCursorPos/SetCursorPos.
      try {
