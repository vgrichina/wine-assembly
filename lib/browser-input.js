...
(function () {
  ...
  function wireCanvasInput(canvas, renderer, deps) {
    ...
    //
    // The gesture takes the first finger's press with it. That press already
    // reached the guest as a WM_LBUTTONDOWN, so entering pinch retires it with
    // a mouse-up at the same point rather than leaving a button stuck down for
