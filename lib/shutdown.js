...
(function () {
  ...
  const HINT_MS = 4000;      // when the footer with the next actions fades in
  ...
  const STYLE = `
    ...
    #wine-power-screen .footer {
      ...
      color: #6a6a6a; opacity: 0; transition: opacity 1.2s ease;
    ...
    #wine-power-screen .footer .actions a {
      ...
      font: inherit; color: #d0d0d0; text-decoration: none;
      background: #1a1a1a; border: 1px solid #4a4a4a; border-radius: 0;
      cursor: pointer;
    }
