...
if (IS_WEB_WORKER) {
  ...
  importScripts('region-map.generated.js?v=281');
  importScripts('worker-imports.js?v=5');
  importScripts('gl-command-stream.js?v=9');
  importScripts('d3d-command-stream.js?v=2');
  importScripts('guest-rpc.js?v=8');
  ...
  importScripts('dll-loader.js?v=172');
} else {
    ...
    if (msg.t === 'init') {
      ...
      if (IS_WEB_WORKER && msg.d3dRenderWorker && self.D3DCommandStream) {
        d3dCommands = new self.D3DCommandStream.Encoder({
          ...
          workerUrl: 'd3d-render-worker.js?v=2',
