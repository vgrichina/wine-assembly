...
| Silent-handler ratchet pin | — | **508 broad** (was 315 exact-shape) | see §P3-3.4 |
...
all 508 straight-line handlers with no call, control-flow branch, fail-loud
...
--app` honors `copySuperops`), 11 (9 DX enumerations, hooks, DDE),
...
closed in code too: 508 broad bodies are hashed, replacement pin lines are
...
classifier now hashes all 508 quiet bodies (any handler with no call, branch,
