...
| Silent-handler ratchet pin | — | **507 broad** (was 315 exact-shape) | see §P3-3.4 |
...
all 507 straight-line handlers with no call, control-flow branch, fail-loud
...
closed in code too: 507 broad bodies are hashed, replacement pin lines are
...
classifier now hashes all 507 quiet bodies (any handler with no call, branch,
