...
- §3.7 named accessors for the *remaining* per-class state structs. The
  ...
  TrackBarState followed in `92217e4`. Edit / ListBox / ComboBox / ListView
  are still raw offsets, and those are the big ones.
...
- §3.8's remaining bullets and §4.3, the dual-ownership and JS-authority arcs
  ...
  real second owners, unlike the geometry globals, and multi-session.
