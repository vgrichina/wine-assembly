...
assert(indexHtml.includes('lib/host-imports.js?v=113'), 'web host should cache-bust host-imports after desktop changes');
assert(!hostJs.includes('?v=55'), 'host.js should not fetch stale WAT/API sources with v55');
assert(hostJs.includes("SOURCE_VERSION = '113'"), 'host.js should define the current WAT/API cache-buster');
