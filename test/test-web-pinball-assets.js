...
assert(indexHtml.indexOf('lib/gdi-surface.js?v=1') < indexHtml.indexOf('lib/host-imports.js?v=195'),
  'web host should load the GDI surface module before host imports');
assert(indexHtml.includes('lib/host-imports.js?v=195'), 'web host should cache-bust host imports after wide WAT line support');
...
assert(indexHtml.includes('host.js?v=191'), 'web host should cache-bust host.js after wide WAT line rasterization');
assert(hostJs.includes("static SOURCE_VERSION = '191'"), 'web host should cache-bust WAT source compilation');
