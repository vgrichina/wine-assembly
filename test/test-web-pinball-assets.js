...
assert(indexHtml.includes('lib/renderer-input.js?v=172'), 'web host should cache-bust renderer input after multi-app pointer routing changes');
assert(indexHtml.includes('lib/renderer.js?v=169'), 'web host should cache-bust renderer after shell notification changes');
assert(indexHtml.includes('lib/host-imports.js?v=179'), 'web host should cache-bust host-imports after window z-order changes');
assert(!hostJs.includes('?v=55'), 'host.js should not fetch stale WAT/API sources with v55');
assert(indexHtml.includes('host.js?v=180'), 'web host should cache-bust host.js after browser host changes');
assert(hostJs.includes("SOURCE_VERSION = '180'"), 'host.js should define the current WAT/API cache-buster');
