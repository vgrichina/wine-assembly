...
assert(webApp.includes('lib/renderer-input.js?v=188'), 'web host should cache-bust renderer input after Paint palette routing');
...
assert(webApp.includes('lib/thread-manager.js?v=177'), 'web host should cache-bust thread manager after naming the module a trapped thread died in');
