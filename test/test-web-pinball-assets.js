...
assert(indexHtml.includes('host.js?v=201'), 'web host should cache-bust host.js after radio-group fixes');
assert(hostJs.includes("static SOURCE_VERSION = '201'"), 'web host should cache-bust WAT source compilation');
