...
assert(pageHtml.includes('lib/browser-shell.js?v=16'),
...
assert(webApp.includes('lib/browser-input.js?v=8'), 'web host should cache-bust the pre-lock relative-mouse gate');
...
assert(webApp.includes('host.js?v=248'), 'web host should cache-bust host.js after OpenGL API delivery');
