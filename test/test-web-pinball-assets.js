...
assert(indexHtml.indexOf('lib/gdi-surface.js?v=1') < indexHtml.indexOf('lib/host-imports.js?v=191'),
  'web host should load the GDI surface module before host imports');
assert(indexHtml.includes('lib/host-imports.js?v=191'), 'web host should cache-bust host imports after WAT region-band presentation bridging');
