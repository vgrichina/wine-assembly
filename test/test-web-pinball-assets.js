...
assert(indexHtml.indexOf('lib/gdi-surface.js?v=1') < indexHtml.indexOf('lib/host-imports.js?v=196'),
  'web host should load the GDI surface module before host imports');
assert(indexHtml.includes('lib/host-imports.js?v=196'), 'web host should cache-bust host imports after styled WAT line support');
...
assert(indexHtml.includes('host.js?v=192'), 'web host should cache-bust host.js after styled WAT line rasterization');
assert(hostJs.includes("static SOURCE_VERSION = '192'"), 'web host should cache-bust WAT source compilation');
