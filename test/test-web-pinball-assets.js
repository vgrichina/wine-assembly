...
assert(indexHtml.includes('host.js?v=182'), 'web host should cache-bust host.js after browser host changes');
assert(hostJs.includes("SOURCE_VERSION = '182'"), 'host.js should define the current WAT/API cache-buster');
