...
assert(webApp.indexOf('lib/gdi-surface.js?v=2') < webApp.indexOf('lib/host-imports.js?v=212'),
  'web host should load the GDI surface module before host imports');
assert(webApp.includes('lib/host-imports.js?v=212'), 'web host should cache-bust the current host imports');
