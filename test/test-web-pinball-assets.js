...
assert(indexHtml.includes('lib/host-imports.js?v=171'), 'web host should cache-bust host-imports after browser host changes');
assert(!hostJs.includes('?v=55'), 'host.js should not fetch stale WAT/API sources with v55');
assert(indexHtml.includes('host.js?v=171'), 'web host should cache-bust host.js after browser host changes');
assert(hostJs.includes("SOURCE_VERSION = '170'"), 'host.js should define the current WAT/API cache-buster');
