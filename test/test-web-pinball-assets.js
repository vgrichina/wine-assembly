...
assert(indexHtml.includes('lib/renderer-input.js?v=164'), 'web host should cache-bust renderer input after desktop changes');
assert(indexHtml.includes('lib/host-imports.js?v=164'), 'web host should cache-bust host-imports after browser host changes');
assert(!hostJs.includes('?v=55'), 'host.js should not fetch stale WAT/API sources with v55');
assert(indexHtml.includes('host.js?v=164'), 'web host should cache-bust host.js after WAT/API source changes');
assert(hostJs.includes("SOURCE_VERSION = '164'"), 'host.js should define the current WAT/API cache-buster');
