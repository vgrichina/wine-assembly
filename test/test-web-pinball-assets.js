...
assert(indexHtml.includes('host.js?v=202'), 'web host should cache-bust host.js after resource-icon fixes');
assert(hostJs.includes("static SOURCE_VERSION = '202'"), 'web host should cache-bust WAT source compilation');
