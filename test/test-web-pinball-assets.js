...
assert(indexHtml.includes('host.js?v=195'), 'web host should cache-bust host.js after EDIT scrollbar painting');
assert(hostJs.includes("static SOURCE_VERSION = '195'"), 'web host should cache-bust WAT source compilation');
