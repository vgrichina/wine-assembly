...
assert(html.includes('lib/gpu-backend.js?v=4') &&
  html.includes('lib/gl-command-stream.js?v=6') &&
  html.includes('lib/gl-compat.js?v=8') &&
  guestWorker.includes("importScripts('gl-command-stream.js?v=6')"),
