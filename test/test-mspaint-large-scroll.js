...
const input = [
  ...
  '70:0x111:57601',
  '120:open-dlg-pick:paint-large.bmp',
  '220:click:284:319',
  '240:assert-standard-scroll:v:70:vertical-arrow',
  '260:click:268:336',
  '280:assert-standard-scroll:h:53:horizontal-arrow',
  '300:mousedown:122:336',
  '301:mousemove:155:336',
  '302:mousemove:180:336',
  '303:mouseup:180:336',
  '330:assert-standard-scroll:h:300:horizontal-thumb',
  '350:click:264:32',
  '390:assert-standard-scroll:v:70:maximized-vertical',
  '391:assert-standard-scroll:h:300:maximized-horizontal',
  '400:dump-windows:maximized',
  '410:stop',
].join(',');
