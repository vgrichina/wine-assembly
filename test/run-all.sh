...
# Every child gets a wall-clock cap and is reported as TIMEOUT. Longer gameplay
# checks have documented exceptions shared with the budget gate. Explicit
# CLI/environment caps remain authoritative; empty env uses defaults.
