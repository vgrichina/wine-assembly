...
const extraWat = String.raw`
  (func (export "test_lfs_setup")
    ...
    (call $gs8 (i32.const 0x00100207) (i32.const 0x8B))
    (call $gs8 (i32.const 0x00100208) (i32.const 0xC8))
    (call $gs8 (i32.const 0x00100209) (i32.const 0x66))
    (call $gs8 (i32.const 0x0010020A) (i32.const 0xBE))
    (call $gs32 (i32.const 0x0010020B) (i32.const 0x00010004))
    (call $gs8 (i32.const 0x0010020F) (i32.const 0x67))
    (call $gs8 (i32.const 0x00100210) (i32.const 0x8B))
    (call $gs8 (i32.const 0x00100211) (i32.const 0x46))
    (call $gs8 (i32.const 0x00100212) (i32.const 0xFC))
    (call $gs8 (i32.const 0x00100213) (i32.const 0xF4))
