  ...
  (func $help_view_hotspot_token_at
    ...
    (local.set $viewport_bottom
      (select (global.get $help_popup_height) (call $help_primary_viewport_height)
  ...
  (func (export "test_help_layout_tokens")
    ...
    (local.set $result (call $help_layout_tokens
      (local.get $raw) (local.get $raw_len)
      (i32.const 0) (i32.const 0)
      (local.get $tokens) (local.get $token_count)
      (local.get $runs) (local.get $run_capacity)
      (local.get $width) (local.get $hdc)
      (i32.const 0) (i32.const 0)))
  ...
  (func (export "get_help_view_layout_width") (result i32)
    (global.get $help_view_layout_width))
  (func (export "get_help_client_width") (result i32)
    (global.get $help_client_width))
  (func (export "get_help_client_height") (result i32)
    (global.get $help_client_height))
  (func (export "get_help_scroll_y") (result i32)
    (global.get $help_scroll_y))
