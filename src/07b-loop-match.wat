                                  ...
                                  (i32.or
                                    ...
                                    (i32.or
                                      ...
                                      (i32.shl
                                        (i32.eq (i32.shr_u (local.get $d3) (i32.const 8)) (i32.const 5))
                                        (i32.const 25))))))))))))
                  (store.field LoopOp handler (local.get $p0) (i32.const 448))
  ...
  ;; 448: one balanced expression pipeline. The decoder proved the original
  ...
  ;; 449: balanced binary expression tree leaf.
        ...
        (then
          ...
          (if (i32.ge_u (local.get $count) (i32.const 3))
            (then
              ...
              (if (global.get $x87_pipeline4_emit_enabled)
                (then
                  (store.field LoopOp handler (local.get $p) (i32.const 450))
