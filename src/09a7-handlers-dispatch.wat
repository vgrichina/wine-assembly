...
(func $dispatch_local (param $name i32) (param $a0 i32) (param $a1 i32) (param $a2 i32)
    ...
    (if (i32.eq (local.get $kind) (i32.const 4))
      (then
        (if (call $gl32 (i32.add (local.get $obj) (i32.const 44)))
          (then (call $ole_release_medium (i32.add (local.get $obj) (i32.const 32)))))))
  ...
  ;; IDataObject layout (64 bytes): +0 vtable, +4 refcount, +8 kind=4,
  ;; +12 FORMATETC[20], +32 STGMEDIUM[12], +44 has-data.
  ;; IEnumFORMATETC layout (24 bytes): +0 vtable, +4 refcount, +8 kind=5,
  ;; +12 data object, +16 current index.
  ...
  (func $ole_create_data_object (param $formatetc i32) (param $medium i32) (result i32)
    ...
    (if (i32.and
      ...
      (then
        ...
        (if (local.get $hr) (then (call $heap_free (local.get $obj)) (return (i32.const 0))))
        (call $gs32 (i32.add (local.get $obj) (i32.const 44)) (i32.const 1))))
    (local.get $obj))
  ...
  (func $ole_create_format_enum (param $data_object i32) (result i32)
    ...
    (call $gs32 (i32.add (local.get $obj) (i32.const 12)) (local.get $data_object))
    (drop (call $ole_obj_addref (local.get $data_object)))
    (local.get $obj))
  ...
  (func $handle_IDataObject_GetData (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    (if (i32.or (i32.eqz (local.get $arg2)) (i32.eqz (call $ole_format_matches (i32.add (local.get $arg0) (i32.const 12)) (local.get $arg1))))
      (then (if (local.get $arg2) (then (call $zero_memory (call $g2w (local.get $arg2)) (i32.const 12)))) (global.set $eax (i32.const 0x80040064)))
      (else (global.set $eax (call $ole_copy_medium (local.get $arg2) (i32.add (local.get $arg0) (i32.const 32))))))
    (global.set $esp (i32.add (global.get $esp) (i32.const 16))))
  ...
  (func $handle_IDataObject_QueryGetData (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    (global.set $eax (select (i32.const 0) (i32.const 0x80040064) (call $ole_format_matches (i32.add (local.get $arg0) (i32.const 12)) (local.get $arg1))))
    (global.set $esp (i32.add (global.get $esp) (i32.const 12))))
  ...
  (func $handle_IDataObject_SetData (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (if (i32.or (i32.eqz (local.get $arg1)) (i32.eqz (local.get $arg2))) (then (global.set $eax (i32.const 0x80004003)))
      (else
        (if (call $gl32 (i32.add (local.get $arg0) (i32.const 44))) (then (call $ole_release_medium (i32.add (local.get $arg0) (i32.const 32)))))
        (memory.copy (call $g2w (i32.add (local.get $arg0) (i32.const 12))) (call $g2w (local.get $arg1)) (i32.const 20))
        (if (local.get $arg3)
          (then
            (memory.copy (call $g2w (i32.add (local.get $arg0) (i32.const 32))) (call $g2w (local.get $arg2)) (i32.const 12))
            (call $zero_memory (call $g2w (local.get $arg2)) (i32.const 12))
            (local.set $hr (i32.const 0)))
          (else (local.set $hr (call $ole_copy_medium (i32.add (local.get $arg0) (i32.const 32)) (local.get $arg2)))))
        (if (i32.eqz (local.get $hr)) (then (call $gs32 (i32.add (local.get $arg0) (i32.const 44)) (i32.const 1))))
  ...
  (func $handle_IEnumFORMATETC_Next (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (if (i32.and
      ...
      (then
        ...
        (global.set $eax (select (i32.const 0) (i32.const 1) (i32.eq (local.get $arg1) (i32.const 1)))))
  ...
  (func $handle_IEnumFORMATETC_Skip (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    (call $gs32 (i32.add (local.get $arg0) (i32.const 16)) (i32.const 1))
    (global.set $eax (select (i32.const 0) (i32.const 1) (i32.eqz (local.get $arg1)))) (global.set $esp (i32.add (global.get $esp) (i32.const 12))))
  (func $handle_IEnumFORMATETC_Reset (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    (call $gs32 (i32.add (local.get $arg0) (i32.const 16)) (i32.const 0))
    (global.set $eax (i32.const 0)) (global.set $esp (i32.add (global.get $esp) (i32.const 8))))
