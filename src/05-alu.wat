...
;; ============================================================
  ...
  (func $th_mul_m32 (param $op i32)
    (local $val i64) (local $addr i32) (local.set $addr (call $read_addr))
  ...
  (func $th_div_m32 (param $op i32)
    (local $divisor i64) (local $dividend i64) (local $quotient i64) (local $addr i32) (local.set $addr (call $read_addr))
