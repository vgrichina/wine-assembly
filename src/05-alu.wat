  ...
  (func $th_div32 (param $op i32)
    ...
    (if (i64.gt_u (local.get $quotient) (i64.const 0xFFFFFFFF))
      (then (call $raise_exception (i32.const 0)) (return)))
  ...
  (func $th_div_m32 (param $op i32)
    ...
    (local.set $quotient (i64.div_u (local.get $dividend) (local.get $divisor)))
    (if (i64.gt_u (local.get $quotient) (i64.const 0xFFFFFFFF))
      (then (call $raise_exception (i32.const 2)) (return)))
    (global.set $eax (i32.wrap_i64 (local.get $quotient)))
  ...
  (func $th_div8 (param $op i32)
    ...
    (if (i32.eqz (local.get $divisor)) (then (call $raise_exception (i32.const 0)) (return)))
    (local.set $quot (i32.div_u (local.get $dividend) (local.get $divisor)))
    (if (i32.gt_u (local.get $quot) (i32.const 0xFF)) (then (call $raise_exception (i32.const 0)) (return)))
  ...
  (func $th_idiv8 (param $op i32)
    ...
    (if (i32.eqz (local.get $divisor)) (then (call $raise_exception (i32.const 1)) (return)))
  ...
  (func $th_muldiv_m8 (param $op i32)
    ...
    (if (i32.eq (local.get $op) (i32.const 2)) (then ;; DIV
      (local.set $dividend (i32.and (global.get $eax) (i32.const 0xFFFF)))
      (if (i32.eqz (local.get $val)) (then (call $raise_exception (i32.const 0)) (return)))
  ...
  (func $th_shld16 (param $op i32)
    ...
    (if (local.get $count) (then
      (call $set_reg16 (local.get $d)
        (i32.and (i32.or (i32.shl (local.get $dst) (local.get $count))
  ...
  (func $th_shrd16 (param $op i32)
    ...
    (if (local.get $count) (then
      (call $set_reg16 (local.get $d)
        (i32.and (i32.or (i32.shr_u (local.get $dst) (local.get $count))
