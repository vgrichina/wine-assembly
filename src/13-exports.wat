  ...
  (func (export "test_call_AddFontResourceA") (param i32) (result i32)
    ...
    (global.set $esp (local.get $saved_esp))
    (global.get $eax))
  (func (export "test_call_CreateScalableFontResourceA")
        (param i32 i32 i32 i32) (result i32)
    (local $saved_esp i32)
    (local.set $saved_esp (global.get $esp))
    ...
    (global.set $esp (local.get $saved_esp))
    (global.get $eax))
  (func (export "test_call_mmioSetBuffer")
        (param i32 i32 i32 i32) (result i32)
    (local $saved_esp i32)
    (local.set $saved_esp (global.get $esp))
  ...
  (func (export "test_call_GetFileVersionInfoA")
    ...
    (global.get $eax))
  (func (export "test_call_GetFileVersionInfoSizeW") (param $name i32) (param $handle i32) (result i32)
    (call $handle_GetFileVersionInfoSizeW (local.get $name) (local.get $handle)
      (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0))
    (global.get $eax))
  (func (export "test_call_GetFileVersionInfoW")
    (param $name i32) (param $handle i32) (param $len i32) (param $data i32) (result i32)
    (call $handle_GetFileVersionInfoW (local.get $name) (local.get $handle)
      (local.get $len) (local.get $data) (i32.const 0) (i32.const 0))
    (global.get $eax))
