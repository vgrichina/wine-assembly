  ...
  (func (export "set_aoe_recompile_enabled") (param $flag i32)
    ...
    (if (local.get $flag)
      (then
        (global.set $aoe_wat_threaded_enabled (i32.const 0))
        (global.set $wat_stack_packet_enabled (i32.const 0))
        (global.set $wat_slot_packet_enabled (i32.const 0))))
    (call $clear_cache))
  ...
  (func (export "set_aoe_wat_threaded_enabled") (param $flag i32)
    ...
    (if (local.get $flag)
      (then
        (global.set $aoe_recompile_enabled (i32.const 0))
        (global.set $wat_stack_packet_enabled (i32.const 0))
        (global.set $wat_slot_packet_enabled (i32.const 0))))
    (call $clear_cache))
  (func (export "get_aoe_wat_threaded_enabled") (result i32)
    (global.get $aoe_wat_threaded_enabled))
  ;; Generic stack-packet executor. The current decoder hook emits only the AoE
  ;; benchmark fixture, but the packet instruction set has no AoE operations.
  (func (export "set_wat_stack_packet_enabled") (param $flag i32)
    (global.set $wat_stack_packet_enabled (local.get $flag))
    (if (local.get $flag)
      (then
        (global.set $aoe_recompile_enabled (i32.const 0))
        (global.set $aoe_wat_threaded_enabled (i32.const 0))
        (global.set $wat_slot_packet_enabled (i32.const 0))))
    (call $clear_cache))
  (func (export "get_wat_stack_packet_enabled") (result i32)
    (global.get $wat_stack_packet_enabled))
  (func (export "set_wat_stack_superops_enabled") (param $flag i32)
    (global.set $wat_stack_superops_enabled (local.get $flag))
    (call $clear_cache))
  (func (export "get_wat_stack_superops_enabled") (result i32)
    (global.get $wat_stack_superops_enabled))
  (func (export "set_wat_stack_packet_count_enabled") (param $flag i32)
    (global.set $wat_stack_packet_count_enabled (local.get $flag)))
  (func (export "get_wat_stack_packet_count_enabled") (result i32)
  ...
  (func (export "set_wat_slot_packet_enabled") (param $flag i32)
    (global.set $wat_slot_packet_enabled (local.get $flag))
    (if (local.get $flag)
      (then
        (global.set $aoe_recompile_enabled (i32.const 0))
        (global.set $aoe_wat_threaded_enabled (i32.const 0))
        (global.set $wat_stack_packet_enabled (i32.const 0))))
    (call $clear_cache))
  (func (export "get_wat_slot_packet_enabled") (result i32)
    (global.get $wat_slot_packet_enabled))
  (func (export "set_wat_slot_packet_allocation_mode") (param $mode i32)
    (global.set $wat_slot_packet_allocation_mode (local.get $mode))
    (call $clear_cache))
  (func (export "get_wat_slot_packet_allocation_mode") (result i32)
    (global.get $wat_slot_packet_allocation_mode))
  (func (export "set_wat_slot_packet_count_enabled") (param $flag i32)
    (global.set $wat_slot_packet_count_enabled (local.get $flag)))
  (func (export "get_wat_slot_packet_entries") (result i32)
    (global.get $wat_slot_packet_entries))
  ...
  (func (export "set_x86_hot_subset_enabled") (param $flag i32)
  ...
  (func (export "reset_aoe_recompile_counters")
    ...
    (global.set $wat_stack_packet_entries (i32.const 0))
    (global.set $wat_slot_packet_entries (i32.const 0)))
