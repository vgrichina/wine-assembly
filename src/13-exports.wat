  ...
  (func (export "test_ole_data_query") (param $obj i32) (param $formatetc i32) (result i32)
    (select (i32.const 0) (i32.const 0x80040064)
      (call $ole_format_matches (i32.add (local.get $obj) (i32.const 12)) (local.get $formatetc))))
  (func (export "test_ole_data_get") (param $obj i32) (param $formatetc i32) (param $medium i32) (result i32)
    (if (result i32) (call $ole_format_matches (i32.add (local.get $obj) (i32.const 12)) (local.get $formatetc))
      (then (call $ole_copy_medium (local.get $medium) (i32.add (local.get $obj) (i32.const 32))))
