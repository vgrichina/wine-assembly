  ...
  (func $win32_dispatch (param $thunk_idx i32)
    ...
    ;; CreateWindowEx continuation: WndProc returned, complete the API
    (if (i32.eq (local.get $name_rva) (i32.const 0xCACA0001))
      (then
        ;; WndProc (stdcall) already cleaned its args+ret via ret 0x10
        ;; Stack is now where CreateWindowExA's caller expects it
