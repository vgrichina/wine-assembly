...
const DESKTOP_BINARY_FILES = new Set([
  ...
  'binaries/winamp.exe',
  'binaries/plugins/cddbcontrolwinamp.dll',
  'binaries/plugins/cddbuiwinamp.dll',
  'binaries/plugins/enc_vorbis.dll',
  'binaries/plugins/gen_ml.dll',
  'binaries/plugins/in_cdda.dll',
  'binaries/plugins/in_midi.dll',
  'binaries/plugins/in_mod.dll',
  'binaries/plugins/in_mp3.dll',
  'binaries/plugins/in_vorbis.dll',
  'binaries/plugins/in_wm.dll',
  'binaries/plugins/out_wave.dll',
  'binaries/plugins/out_wm.dll',
  'binaries/plugins/read_file.dll',
  'binaries/demo.mp3',
