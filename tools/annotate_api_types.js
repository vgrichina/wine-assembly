...
const TYPED = {
  ...
  CLSIDFromProgID: { args: [{ name: 'progId', type: 'LPCWSTR' }, { name: 'clsid', type: 'DWORD' }], ret: 'DWORD' },
  OleRun: { args: [{ name: 'unknown', type: 'HANDLE' }], ret: 'DWORD' },
  OleIsRunning: { args: [{ name: 'object', type: 'HANDLE' }], ret: 'BOOL' },
  OleLockRunning: { args: [{ name: 'unknown', type: 'HANDLE' }, { name: 'lock', type: 'BOOL' }, { name: 'lastUnlockCloses', type: 'BOOL' }], ret: 'DWORD' },
  CoGetMalloc: { args: [{ name: 'context', type: 'DWORD' }, { name: 'ppMalloc', type: 'DWORD' }], ret: 'DWORD' },
  CoSetState: { args: [{ name: 'state', type: 'HANDLE' }], ret: 'DWORD' },
  CoGetState: { args: [{ name: 'ppState', type: 'DWORD' }], ret: 'DWORD' },

  // — DirectAnimation Automation placeholders —
  IDirectAnimationDAView_QueryInterface: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'riid', type: 'DWORD' }, { name: 'ppv', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAView_AddRef: { args: [{ name: 'this', type: 'HANDLE' }], ret: 'DWORD' },
  IDirectAnimationDAView_Release: { args: [{ name: 'this', type: 'HANDLE' }], ret: 'DWORD' },
  IDirectAnimationDAView_GetTypeInfoCount: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'pctinfo', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAView_GetTypeInfo: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'iTInfo', type: 'UINT' }, { name: 'lcid', type: 'DWORD' }, { name: 'ppTInfo', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAView_GetIDsOfNames: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'riid', type: 'DWORD' }, { name: 'names', type: 'LPOLESTRARRAY' }, { name: 'cNames', type: 'UINT' }, { name: 'lcid', type: 'DWORD' }, { name: 'dispids', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAView_Invoke: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'dispid', type: 'INT' }, { name: 'riid', type: 'DWORD' }, { name: 'lcid', type: 'DWORD' }, { name: 'flags', type: 'DWORD' }, { name: 'params', type: 'DISPPARAMS' }, { name: 'result', type: 'DWORD' }, { name: 'excep', type: 'DWORD' }, { name: 'argErr', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAStatics_QueryInterface: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'riid', type: 'DWORD' }, { name: 'ppv', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAStatics_AddRef: { args: [{ name: 'this', type: 'HANDLE' }], ret: 'DWORD' },
  IDirectAnimationDAStatics_Release: { args: [{ name: 'this', type: 'HANDLE' }], ret: 'DWORD' },
  IDirectAnimationDAStatics_GetTypeInfoCount: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'pctinfo', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAStatics_GetTypeInfo: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'iTInfo', type: 'UINT' }, { name: 'lcid', type: 'DWORD' }, { name: 'ppTInfo', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAStatics_GetIDsOfNames: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'riid', type: 'DWORD' }, { name: 'names', type: 'LPOLESTRARRAY' }, { name: 'cNames', type: 'UINT' }, { name: 'lcid', type: 'DWORD' }, { name: 'dispids', type: 'DWORD' }], ret: 'DWORD' },
  IDirectAnimationDAStatics_Invoke: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'dispid', type: 'INT' }, { name: 'riid', type: 'DWORD' }, { name: 'lcid', type: 'DWORD' }, { name: 'flags', type: 'DWORD' }, { name: 'params', type: 'DISPPARAMS' }, { name: 'result', type: 'DWORD' }, { name: 'excep', type: 'DWORD' }, { name: 'argErr', type: 'DWORD' }], ret: 'DWORD' },
  IMalloc_Alloc: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'size', type: 'DWORD' }], ret: 'HANDLE' },
  IMalloc_Realloc: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'ptr', type: 'HANDLE' }, { name: 'size', type: 'DWORD' }], ret: 'HANDLE' },
  IMalloc_Free: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'ptr', type: 'HANDLE' }] },
  IMalloc_GetSize: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'ptr', type: 'HANDLE' }], ret: 'DWORD' },
  IMalloc_DidAlloc: { args: [{ name: 'this', type: 'HANDLE' }, { name: 'ptr', type: 'HANDLE' }], ret: 'INT' },
  ...
  MulDiv:          { args: [{ name: 'number', type: 'INT' }, { name: 'numerator', type: 'INT' }, { name: 'denominator', type: 'INT' }], ret: 'INT' },
  ...
  GetClientRect:   { args: [{ name: 'hwnd', type: 'HWND' }, { name: 'rect', type: 'LPRECT', out: true }], ret: 'BOOL' },
  GetWindowRect:   { args: [{ name: 'hwnd', type: 'HWND' }, { name: 'rect', type: 'LPRECT', out: true }], ret: 'BOOL' },
  SetRect:         { args: [{ name: 'rect', type: 'LPRECT', out: true }, { name: 'left', type: 'INT' }, { name: 'top', type: 'INT' }, { name: 'right', type: 'INT' }, { name: 'bottom', type: 'INT' }], ret: 'BOOL' },
  OffsetRect:      { args: [{ name: 'rect', type: 'LPRECT', out: true }, { name: 'dx', type: 'INT' }, { name: 'dy', type: 'INT' }], ret: 'BOOL' },
  InflateRect:     { args: [{ name: 'rect', type: 'LPRECT', out: true }, { name: 'dx', type: 'INT' }, { name: 'dy', type: 'INT' }], ret: 'BOOL' },
  IntersectRect:   { args: [{ name: 'dst', type: 'LPRECT', out: true }, { name: 'src1', type: 'LPRECT' }, { name: 'src2', type: 'LPRECT' }], ret: 'BOOL' },
  ScreenToClient:  { args: [{ name: 'hwnd', type: 'HWND' }, { name: 'point', type: 'LPPOINT', out: true }], ret: 'BOOL' },
  ClientToScreen:  { args: [{ name: 'hwnd', type: 'HWND' }, { name: 'point', type: 'LPPOINT', out: true }], ret: 'BOOL' },
  MapWindowPoints: { args: [{ name: 'from', type: 'HWND' }, { name: 'to', type: 'HWND' }, { name: 'points', type: 'LPPOINT', out: true }, { name: 'count', type: 'UINT' }], ret: 'DWORD' },
  ...
  // — GDI metrics —
  GetDC:           { args: [{ name: 'hwnd', type: 'HWND' }], ret: 'HDC' },
  ReleaseDC:       { args: [{ name: 'hwnd', type: 'HWND' }, { name: 'hdc', type: 'HDC' }], ret: 'INT' },
  CreateICA:       { args: [{ name: 'driver', type: 'LPCSTR' }, { name: 'device', type: 'LPCSTR' }, { name: 'output', type: 'LPCSTR' }, { name: 'init', type: 'DWORD' }], ret: 'HDC' },
  CreateICW:       { args: [{ name: 'driver', type: 'LPCWSTR' }, { name: 'device', type: 'LPCWSTR' }, { name: 'output', type: 'LPCWSTR' }, { name: 'init', type: 'DWORD' }], ret: 'HDC' },
  GetDeviceCaps:   { args: [{ name: 'hdc', type: 'HDC' }, { name: 'index', type: 'INT' }], ret: 'INT' },
  GetStockObject:  { args: [{ name: 'object', type: 'INT' }], ret: 'HANDLE' },
  SelectObject:    { args: [{ name: 'hdc', type: 'HDC' }, { name: 'object', type: 'HANDLE' }], ret: 'HANDLE' },
  GetCurrentObject:{ args: [{ name: 'hdc', type: 'HDC' }, { name: 'objectType', type: 'INT' }], ret: 'HANDLE' },
  CreateFontIndirectA: { args: [{ name: 'lf', type: 'LPLOGFONTA' }], ret: 'HANDLE' },
  CreateFontIndirectW: { args: [{ name: 'lf', type: 'LPLOGFONTW' }], ret: 'HANDLE' },
  GetObjectA:      { args: [{ name: 'object', type: 'HANDLE' }, { name: 'bytes', type: 'INT' }, { name: 'buffer', type: 'LPLOGFONTA', out: true }], ret: 'INT' },
  GetObjectW:      { args: [{ name: 'object', type: 'HANDLE' }, { name: 'bytes', type: 'INT' }, { name: 'buffer', type: 'LPLOGFONTW', out: true }], ret: 'INT' },
  GetTextMetricsA: { args: [{ name: 'hdc', type: 'HDC' }, { name: 'tm', type: 'LPTEXTMETRICA', out: true }], ret: 'BOOL' },
  GetTextMetricsW: { args: [{ name: 'hdc', type: 'HDC' }, { name: 'tm', type: 'LPTEXTMETRICW', out: true }], ret: 'BOOL' },
  GetCharWidthA:   { args: [{ name: 'hdc', type: 'HDC' }, { name: 'first', type: 'UINT' }, { name: 'last', type: 'UINT' }, { name: 'widths', type: 'DWORD' }], ret: 'BOOL' },
  GetCharWidthW:   { args: [{ name: 'hdc', type: 'HDC' }, { name: 'first', type: 'UINT' }, { name: 'last', type: 'UINT' }, { name: 'widths', type: 'DWORD' }], ret: 'BOOL' },
  GetMapMode:      { args: [{ name: 'hdc', type: 'HDC' }], ret: 'INT' },
  SetMapMode:      { args: [{ name: 'hdc', type: 'HDC' }, { name: 'mode', type: 'INT' }], ret: 'INT' },
